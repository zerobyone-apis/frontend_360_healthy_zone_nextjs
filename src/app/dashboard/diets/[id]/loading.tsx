		...
		<>
			<div className="flex flex-col items-center">
				...
				<label
					className={clsx(
						"p-1 rounded ",
						DietResumeCardStyles["IN PROGRESS"].label
					)}
				>
				...
				<div className="mt-4 ml-6">
					<HorizontalTimeline
						init_on={
							<div className="h-3 bg-gray-200 rounded-full  w-[25px] mb-4"></div>
						}
						end_on={
							<div className="h-3 bg-gray-200 rounded-full  w-[25px] mb-4"></div>
						}
				...
				<div className="grid grid-cols-2 w-full p-4 gap-2">
					<DefaultCard
						...
						title="Recipes"
						body={
							<div className="h-2 bg-gray-200 rounded-full w-full mb-4 max-w-50"></div>
						}
					/>
					<DefaultCard
					...
					<DefaultCard
						...
						bodyClasses="text-violet-900 whitespace-pre-line"
					...
					/>
					<DefaultCard
						classes="col-span-2 md:col-span-2 border-teal-300 border-5 bg-teal-100 border-l-8"
						titleClasses="text-teal-800 mb-2 text-2xl font-bold tracking-tight"
						bodyClasses="text-teal-900 whitespace-pre-line"
			...
			<div className="w-full flex justify-center">
				<Button
					disabled
					className="bg-jungle-green-500 rounded text-white hover:bg-jungle-green-400 fixed md:bottom-4 bottom-20 font-sans font-bold gap-1"
				>
