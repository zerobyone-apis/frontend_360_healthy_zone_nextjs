...
export default function RestView({
	...
	return (
		<div
			className="h-full p-4 rounded w-full bg-jungle-green-500 flex justify-center flex-col items-center gap-3 overflow-auto"
		...
		>
			...
			<div className="flex gap-3">
				...
				<Button
					...
					className="text-jungle-green-500 bg-white rounded"
				>
					Go ahead!
				</Button>
			</div>
