...
export default function ProgressCard({ target, percent, bcolor, tcolor, currentProgress, title, icon }: Props) {
        ...
        <div className="h-[275px] flex justify-end flex-col w-full">
            <div className='w-full h-[237px] max-w-full max-h-full border rounded-3xl shadow-lg flex flex-col justify-around items-center bg-white'>
                <div className={clsx(`rounded-3xl w-[92px] h-[83px] relative flex justify-center items-center -top-8`, bcolor)}>
                    <i className={clsx(icon ? icon : "bx bx-run", 'text-4xl font-bold text-white')}></i>
                </div>
                <div className=''>
