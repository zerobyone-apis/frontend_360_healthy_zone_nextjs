...
export function Pricing() {
    ...
    return (
        <section className="bg-white dark:bg-gray-900 h-full relative" >
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    ...
                    <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Choose a plan that's right far your fitness life. Simple pricing & No hidden charges.</p>
                </div>
