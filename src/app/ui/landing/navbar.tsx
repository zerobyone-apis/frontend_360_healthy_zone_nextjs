		...
		<div className="w-full flex justify-center fixed z-10">
			<nav className="bg-white shadow-xl flex justify-around items-center px-2 py-2 mt-5  w-[95%] rounded-full border border-slate-200" >
				...
				<div className="flex gap-2">
					<Button className="rounded-full bg-jungle-green-500 hover:bg-jungle-green-300">Sign up</Button>
					<Button className="rounded-full  border-android-green-500 border hover:bg-android-green-300">Sign in</Button>
				</div>
			</nav>
		</div>
	);
