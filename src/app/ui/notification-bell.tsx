...
/**
 * 
 * FALTA RETOCAR MUCHO DISEÑO, AGREGAR PROPS Y DOCUMENTAR SU USO.
 * NO UTILIZAR, ESTE COMPONENTE ESTA IN PROGRESS
 */
export function NotificationBell({ }: Props) {
    ...
    return (
        <>
            <button id="dropdownNotificationButton" onClick={() => setToggle((state) => !state)} className="relative inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" type="button">
            ...
            <div id="dropdownNotification" className={clsx(!toggle && "hidden", "z-[200] sticky w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700")}>
