...
export default function NewGoalDialog() {
	...
	const [selectedNutritionistPlan, setSelectedNutritionistPlan] = useState("");
	...
	const handleCreateGoal = async () => {
		...
		if (!selectedGoalType || !selectedNutritionistPlan || !goalDescription) {
		...
		const goal = {
			...
			nutritionist_plans: selectedNutritionistPlan,
			trainer_plans: null,
						...
						<form className="max-w-sm mx-auto grid grid-cols-4 gap-2">
							...
							<div className="col-span-2">
								...
								<select
									id="diet-plan"
									className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
									value={selectedNutritionistPlan}
									onChange={e => setSelectedNutritionistPlan(e.target.value)}
									required
								>
									...
									<option value="HEALTHY_EAT_AND_LOSE_WEIGHT">Healthy eat and weight</option>
