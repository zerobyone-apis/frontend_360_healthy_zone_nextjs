...
import { registration } from "@/actions/signupActions";
                ...
                <div className="w-full sm:h-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6 grid grid-cols-2 gap-2">
                            ...
                            <button type="button" onClick={handleSignupForm} className="col-span-2 w-full text-white bg-jungle-green-600 hover:bg-jungle-green-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
