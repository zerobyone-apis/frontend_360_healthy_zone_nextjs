...
export default function Page() {
	...
	async function handleSignupForm() {
		...
		try {
			...
			if (resp) {
				...
				return router.push("/success-registration");
			}
			toast.error("There was an internal error, please try again later");
		} catch (e) {
			toast.error("There was an internal error, please try again later");
		}
	}
	...
	return (
		<section className="bg-jungle-green-50 ">
			<Link
				href="/"
				className="hidden md:flex items-center mt-2 mb-6 text-2xl font-semibold text-gray-900 "
			>
