...
export const trainingStore = create((set) => ({
  ...
  resetTraining: () => set({ training: { coach_id: 0, goal_id: 0, type: "", training_status: null, coach_plans: "", description_training: "", frequency: "", init_on: null, amount_of_days: 0, dailyTrainingDays: [] } }),
